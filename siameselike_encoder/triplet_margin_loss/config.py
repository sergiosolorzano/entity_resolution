...
eval_data_tabular_numeric_encoder_encoder_fname = "eval_data_tne_triplet_nn_kaggle_dummy_largecut.csv"#"eval_data_tne_triplet_nn_kaggle_dummy_small.csv"
eval_labels_tabular_numeric_encoder_encoder_fname = "eval_labels_tne_triplet_nn_kaggle_dummy_largecut.csv"#"eval_labels_tne_triplet_nn_kaggle_dummy_small.csv"

infer_data_tabular_numeric_encoder_fname = "test_enhanced_data.csv"
...
tne_batch_size = 128
tne_train_eval_dataloader_shuffle = True
...
# Loss Criterion
loss_function = "tripletmargin" #"contrastive" "tripletmargin" or "tripletmargin_mining"
contrastive_margin = 2 #embeddings are l2 -> cap margin to 2
...
# VISUALIZATION
###############################################################################
#region VISUALIZATION: Careful - possible memory issues with multiple per epoch graphs
